...
export const links = sqliteTable('links', {
  ...
  status: text('status', { enum: ['active', 'inactive', 'expired', 'deleted'] })
    .notNull()
    .default('active'),
  type: text('type', { enum: ['direct', 'campaign', 'dynamic'] })
    .notNull()
    .default('direct'),
  ...
  domainIdIdx: index('links_domain_id_idx').on(table.domainId),
...
export const domains = sqliteTable('domains', {
  ...
  isDefault: integer('is_default', { mode: 'boolean' })
    .notNull()
    .default(false),
  status: text('status', { enum: ['active', 'pending', 'failed'] })
    .notNull()
    .default('pending'),
